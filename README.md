...
4. סיכום יומי במייל:
   ...
   - הסיכום כולל כעת מדדי ניהול, עובדים שלא דיווחו, משמרות פתוחות, פרויקטים באיחור או ללא עדכון, המתנה ממושכת להיתרים, משימות ישנות ותמונת מצב ציוד
   - הפעולות מדורגות לפי חומרה ומוצגות בראש המייל, וחישובי היום והתזמון נעשים לפי `Asia/Jerusalem`
...
ואז להריץ ב-SQL Editor את קובץ התזמון. הקובץ שולח בשעה 17:00 לפי שעון ישראל
ומתחשב אוטומטית במעבר בין שעון קיץ לחורף:
